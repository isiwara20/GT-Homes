...
$message = (APP_ENV === 'development' && isset($debugMessage))
    ? $debugMessage
...
<head>
  ...
  <title>Server Error — <?= e(APP_NAME) ?></title>
...
<body>
  <div>
    ...
    <h1 style="font-size:1.5rem; margin:1rem 0;">Server Error</h1>
    <p style="color:var(--color-muted); margin-bottom:2rem;"><?= e($message) ?></p>
