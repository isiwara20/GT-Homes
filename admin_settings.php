...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $settings = [
        ...
        'email'           => sanitize($_POST['email'] ?? 'info@gthomes.lk'),
        'address'         => sanitize($_POST['address'] ?? 'No 123, Resort Road, Sri Lanka'),
...
$currentSettings = $_SESSION['site_settings_custom'] ?? [
    ...
    'email'           => 'info@gthomes.lk',
    'address'         => 'GT HOMES Holiday Resort, Sri Lanka',
